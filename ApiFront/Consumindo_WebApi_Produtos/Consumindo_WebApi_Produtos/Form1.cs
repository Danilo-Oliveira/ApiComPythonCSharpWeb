...
namespace Consumindo_WebApi_Produtos
{
    public partial class Form1 : Form
    {
        ...
        private void InputBox()
        {
            ...
            string Resultado = Microsoft.VisualBasic.Interaction.InputBox(Prompt, Titulo, "7", 600, 350);
        ...
        private async void AddProduto()
        {
            ...
            prod.name = InputBox2(1, "Testea", "Inserir um nome.");
            prod.email = InputBox2(2, "Teste@Teste.com", "Inserir um email.");
        ...
        public static string InputBox2(int Item, string Dado, string Tit)

        {

            /* usando a função VB.Net para exibir um prompt para o usuário informar a senha */
            string Prompt = Tit;
            string Titulo = "www.jorge.net";
            string Resultado = "";

            if (Item == 1)
            {
                Resultado = Microsoft.VisualBasic.Interaction.InputBox(Prompt, Titulo, Dado, 600, 350);
            }
            if (Item == 2)
            {
                Resultado = Microsoft.VisualBasic.Interaction.InputBox(Prompt, Titulo, Dado, 600, 350);
